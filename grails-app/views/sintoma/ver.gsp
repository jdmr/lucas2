	...
	<body>
		...
		<div id="show-sintoma" class="content scaffold-show" role="main">
			...
			<ol class="property-list sintoma">
				...
				<g:if test="${sintoma?.nombre}">
				<li class="fieldcontain">
					<span id="nombre-label" class="property-label"><g:message code="sintoma.nombre.label" default="Nombre" /></span>
					
						<span class="property-value" aria-labelledby="nombre-label"><g:fieldValue bean="${sintoma}" field="nombre"/></span>
			...
			<g:form>
				<fieldset class="buttons">
					<g:hiddenField name="id" value="${sintoma?.id}" />
					<g:link class="edit" action="edita" id="${sintoma?.id}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
